...
public class Episode
{
    ...
    [JsonPropertyName("air_date")] public DateTime? AirDate { get; }
    [JsonPropertyName("episode")] public string EpisodeCode { get; }
    [JsonPropertyName("characters")] public IEnumerable<Uri> Characters { get; }
